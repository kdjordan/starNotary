...
it('lets 2 users exchange stars', async() => {
    ...
    let star1Id = 13;
    let star2Id = 23;
    await instance.createStar('Test Star 1', star1Id, {from: user1});
    await instance.createStar('Test Star 2', star2Id, {from: user2});
    // 2. Call the exchangeStars functions implemented in the Smart Contract
    await instance.exchangeStars(star1Id, star2Id, {from: user1});
    // 3. Verify that the owners changed
    // console.log('owner is', await instance.ownerOf(3))
